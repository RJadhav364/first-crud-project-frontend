        ...
        token && id ? (
                ...
                <div className="relative mt-12 w-full max-w-lg sm:mt-10">
                    ...
                    <div
                        ...
                        <div className="flex flex-col p-6">
                            <h3 className="text-xl font-semibold leading-6 tracking-tighter">Reset Password</h3>
                            <p className="mt-1.5 text-sm font-medium text-white/50">A changed password can mean endless possibilities for security.
                            </p>
                        </div>
                                    ...
                                    <div>
                                        <div
                                            ...
                                            <div className="flex justify-between">
                                                <label
                                                    className="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">New Password</label>
                                ...
                                <div className="mt-4">
                                    <div>
                                        <div
                                            ...
                                            <div className="flex justify-between">
                                                <label
                                                    className="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">Confirm New Password</label>
                                            </div>
            ...
            <section className="flex items-center h-full p-16">
                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                    ...
                    <p className="text-2xl font-semibold md:text-3xl text-gray-50">Sorry, we couldn't find this page.</p>
